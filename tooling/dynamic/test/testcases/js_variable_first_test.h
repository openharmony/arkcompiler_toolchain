        ...
        */
        const std::map<std::string, std::vector<std::string>> variableMap_ = {
            ...
            { "generator0", { "function", "Generator", "function* generator0( { [js code] }",
                              "Cannot get source code" } },
            { "map0", { "object", "map", "Map", "Map(0)", "[object Map]", "size", "number", "0", "0", "[[Map]]",
                        "object", "array", "Array", "Array(0)", "" } },
            { "set0", { "object", "set", "Set", "Set(0)", "[object Set]", "size", "number", "0", "0", "[[Set]]",
                        "object", "array", "Array", "Array(0)", "" } },
            ...
            { "set1", { "object", "set", "Set", "Set(1) {1}", "[object Set]", "size", "number", "1", "1",
                        "[[Set]]", "object", "array", "Array", "Array(1)", "1" } },
            { "set2", { "object", "set", "Set", "Set(7) {'h', 'e', 'l', 'o', 'w', ...}", "[object Set]", "size",
                        "number", "7", "7", "[[Set]]", "object", "array", "Array", "Array(7)",
                        "h,e,l,o,w,r,d" } },
            { "set3", { "object", "set", "Set", "Set(1) {Object}", "[object Set]", "size", "number", "1", "1",
                        "[[Set]]", "object", "array", "Array", "Array(1)", "[object Object]" } },
            { "set4", { "object", "set", "Set", "Set(0)", "[object Set]", "size", "number", "0", "0", "[[Set]]",
                        "object", "array", "Array", "Array(0)", "" } },
            { "set5", { "object", "set", "Set", "Set(2) {'Apple', 'Banana'}", "[object Set]", "size", "number", "2",
                        "2", "[[Set]]", "object", "array", "Array", "Array(2)", "Apple,Banana" } },
            { "set6", { "object", "set", "Set", "Set(0)", "[object Set]", "size", "number", "0", "0", "[[Set]]",
                        "object", "array", "Array", "Array(0)", "" } },
            { "set7", { "object", "set", "Set", "Set(0)", "[object Set]", "size", "number", "0", "0", "[[Set]]",
                        "object", "array", "Array", "Array(0)", "" } },
            ...
            { "set13", { "object", "set", "Set", "Set(1) {Object}", "[object Set]", "size", "number", "1", "1",
                         "[[Set]]", "object", "array", "Array", "Array(1)", "[object Object]" } },
            { "set14", { "object", "set", "Set", "Set(0)", "[object Set]", "size", "number", "0", "0", "[[Set]]",
                         "object", "array", "Array", "Array(0)", "" } },
            { "set15", { "object", "set", "Set", "Set(4) {0, 'hello', Object, 1}", "[object Set]", "size",
                         "number", "4", "4", "[[Set]]", "object", "array", "Array", "Array(4)",
            ...
            { "string15", { "object", "Object", "String{[[PrimitiveValue]]: Cannot get source code}",
                            "Cannot get source code", "[[PrimitiveValue]]", "string",
                            "Cannot get source code", "Cannot get source code", "0", "string",
            ...
            { "string20", { "object", "Object", "String{[[PrimitiveValue]]: [object Map]}", "[object Map]",
                            ...
                            "]", "]", "length", "number", "12", "12" } },
            { "string21", { "object", "Object", "String{[[PrimitiveValue]]: Cannot get source code}",
                            "Cannot get source code", "[[PrimitiveValue]]", "string",
                            "Cannot get source code", "Cannot get source code", "0", "string",
                            "C", "C", "1", "string", "a", "a", "2", "string", "n", "n", "3", "string", "n", "n", "4",
                            "string", "o", "o", "5", "string", "t", "t", "6", "string", " ", " ", "7", "string", "g",
            ...
            { "boolean29", { "object", "Object", "Boolean{[[PrimitiveValue]]: true}", "true", "[[PrimitiveValue]]",
                             "boolean", "true", "true" } },
            { "map1", { "object", "map", "Map", "Map(0)", "[object Map]", "size", "number", "0", "0", "[[Map]]",
                        "object", "array", "Array", "Array(0)", "" } },
            { "map2", { "object", "map", "Map", "Map(2) {1 => 'hello', 2 => 'world'}", "[object Map]", "size",
                        "number", "2", "2", "[[Map]]", "object", "array", "Array", "Array(2)",
                        "[object Object],[object Object]" } },
            { "map3", { "object", "map", "Map", "Map(1) {NaN => 'NaN'}", "[object Map]", "size", "number", "1", "1",
                        "[[Map]]", "object", "array", "Array", "Array(1)", "[object Object]" } },
            { "map4", { "object", "map", "Map", "Map(0)", "[object Map]", "size", "number", "0", "0", "[[Map]]",
                        "object", "array", "Array", "Array(0)", "", "0", "string", "hello", "hello" } },
            { "map5", { "object", "map", "Map", "Map(4) {0 => 'zero', 1 => 'one', 2 => 'two', 3 => 'three'}",
                        "[object Map]", "size", "number", "4", "4", "[[Map]]", "object", "array", "Array",
            ...
            { "map6", { "object", "map", "Map", "Map(1) {Object => 'set0'}", "[object Map]", "size", "number", "1",
                        "1", "[[Map]]", "object", "array", "Array", "Array(1)", "[object Object]" } },
            ...
            { "map8", { "object", "map", "Map", "Map(1) {'helloworld' => 'string0'}", "[object Map]", "size",
                        "number", "1", "1", "[[Map]]", "object", "array", "Array", "Array(1)",
                        "[object Object]" } },
            ...
            { "map13", { "object", "map", "Map", "Map(1) {Object => 'generator0'}", "[object Map]", "size", "number",
                         "1", "1", "[[Map]]", "object", "array", "Array", "Array(1)", "[object Object]" } },
            ...
            { "object5", { "object", "Object", "String{[[PrimitiveValue]]: helloworld}", "helloworld",
                           ...
                           "o", "5", "string", "w", "w", "6", "string", "o", "o", "7", "string", "r", "r", "8",
                           "string", "l", "l", "9", "string", "d", "d", "length", "number", "10", "10" } },
            { "object6", { "object", "map", "Map", "Map(0)", "[object Map]", "size", "number", "0", "0", "[[Set]]",
                           "object", "array", "Array", "Array(0)", "" } },
