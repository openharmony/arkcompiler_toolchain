    ...
    private:
        ...
        */
        const std::map<std::string, std::vector<std::string>> variableMap_ = {
            ...
            { "array9", { "object", "array", "Array", "Array(1)", "Cannot get source code", "0", "function",
                          "Function", "function function0( { [js code] }", "Cannot get source code",
                          "length", "number", "1", "1" } },
            ...
            { "array14", { "object", "array", "Array", "Array(1)", "Cannot get source code", "0",
                           "function", "Generator", "function* generator0( { [js code] }",
                           "Cannot get source code", "length", "number", "1", "1" } },
            ...
            { "weakMap0", { "object", "weakmap", "Weakmap", "WeakMap(0)", "[object WeakMap]",
                            "[[WeakMap]]", "object", "array", "Array", "Array(0)", "" } },
            ...
            { "class1", { "object", "Object", "customClass", "[object Object]", "_a", "number", "1", "1",
                          ...
                          "function", "Function", "function ( { [js code] }", "Cannot get source code" } },
