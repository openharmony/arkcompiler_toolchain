...
private:
    ...
    static Local<JSValueRef> GetModuleValue(const EcmaVM *vm, Local<StringRef> name);
    ...
    static bool SetLexicalValue(const EcmaVM *vm, const FrameHandler *frameHandler,
                                Local<StringRef> name, Local<JSValueRef> value);
    static bool SetModuleValue(const EcmaVM *vm, Local<StringRef> name, Local<JSValueRef> value);
