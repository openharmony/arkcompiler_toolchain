...
public:
    JsClosureScopeFirstTest()
    {
        ...
        loadModule = [this](std::string_view moduleName) {
            std::string pandaFile = DEBUGGER_ABC_DIR "closure_scope_first.abc";
            std::string sourceFile = DEBUGGER_JS_DIR "closure_scope_first.js";
        ...
        channel_ = new JsClosureScopeFirstTestChannel();
    }
...
private:
    class JsClosureScopeFirstTestChannel : public TestChannel {
    public:
        JsClosureScopeFirstTestChannel() = default;
        ~JsClosureScopeFirstTestChannel() = default;
    ...
    private:
        NO_COPY_SEMANTIC(JsClosureScopeFirstTestChannel);
        NO_MOVE_SEMANTIC(JsClosureScopeFirstTestChannel);
...
std::unique_ptr<TestEvents> GetJsClosureScopeFirstTest()
{
    return std::make_unique<JsClosureScopeFirstTest>();
}
} // namespace panda::ecmascript::tooling::test

#endif  // ECMASCRIPT_TOOLING_TEST_UTILS_TESTCASES_JS_CLOSURE_SCOPE_FIRST_TEST_H
