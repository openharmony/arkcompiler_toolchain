...
#ifndef ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPSAMPLING_RECURSION_TEST_H
#define ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPSAMPLING_RECURSION_TEST_H

#include "tooling/test/client_utils/test_util.h"

namespace panda::ecmascript::tooling::test {
class JsHeapSamplingRecursionTest : public TestActions {
public:
    JsHeapSamplingRecursionTest()
    {
        testAction = {
    ...
    ~JsHeapSamplingRecursionTest() = default;
...
std::unique_ptr<TestActions> GetJsHeapSamplingRecursionTest()
{
    return std::make_unique<JsHeapSamplingRecursionTest>();
}
} // namespace panda::ecmascript::tooling::test

#endif // ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPSAMPLING_RECURSION_TEST_H
