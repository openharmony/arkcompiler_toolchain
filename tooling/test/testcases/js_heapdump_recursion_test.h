...
#ifndef ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPDUMP_RECURSION_TEST_H
#define ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPDUMP_RECURSION_TEST_H

#include "tooling/test/client_utils/test_util.h"

namespace panda::ecmascript::tooling::test {
class JsHeapdumpRecursionTest : public TestActions {
public:
    JsHeapdumpRecursionTest()
    {
        testAction = {
    ...
    ~JsHeapdumpRecursionTest() = default;
...
std::unique_ptr<TestActions> GetJsHeapdumpRecursionTest()
{
    return std::make_unique<JsHeapdumpRecursionTest>();
}
} // namespace panda::ecmascript::tooling::test

#endif // ECMASCRIPT_TOOLING_TEST_TESTCASES_JS_HEAPDUMP_RECURSION_TEST_H
