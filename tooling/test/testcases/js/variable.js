...
var o = {
    "foo" : function() {
        ...
        var boolean12 = new Boolean(date0);
        var boolean13 = boolean0 && boolean10;
        var boolean14 = boolean0 || boolean10;
        var boolean15 = !boolean10;
        var boolean16 = new Boolean("hello");
        var boolean17 = new Boolean("");
        var boolean18 = new Boolean(function0);
        var boolean19 = new Boolean(map0);
        var boolean20 = new Boolean(set0);
        var boolean21 = new Boolean(number0);
        var boolean22 = new Boolean(string0);
        var boolean23 = new Boolean(obj0);
        var boolean24 = new Boolean(undefined0);
        var boolean25 = new Boolean(array0);
        var boolean26 = new Boolean(date0);
        var boolean27 = new Boolean(generator0);
        var boolean28 = new Boolean(regexp0);
        var boolean29 = new Boolean(arraybuffer0);
        var boolean30 = new Boolean(uint8array0);
        var boolean31 = new Boolean(dataview0);
        ...
        var map12 = new Map();
        map12.set(date0, "date0");
        var map13 = new Map();
        map13.set(map3, "map3");
        var map14 = new Map();
        map14.set(generator0, "generator0");
        var map15 = new Map();
        map15.set(regexp0, "regexp0");
        var map16 = new Map();
        map16.set(arraybuffer0, "arraybuffer0");
        var map17 = new Map();
        map17.set(uint8array0, "uint8array0");
        var map18 = new Map();
        map18.set(dataview0, "dataview0");
        var map19 = new Map();
        map19.set(bigint10, "bigint10");
        var map20 = new Map();
        map20.set(function0, "function0");
        ...
        var object11 = new Object(date0);
        var object12 = new Object(bigint10);
        var object13 = new Object(generator0);
        var object14 = new Object(regexp0);
        var object15 = new Object(bigint0);
        var object16 = new Object(arraybuffer0);
        var object17 = new Object(uint8array0);
        var object18 = new Object(dataview0);
        var object19 = new Object(boolean10);
        var object20 = new Object(function0);

        var date1 = new Date('2014-01-01');
        var date2 = new Date('1995-12-17T03:24:00');
        var date3 = new Date("October 13, 1975 11:13:00");
        var date4 = new Date(79, 5, 24);
        var date5 = new Date(79, 5, 24, 11, 33, 0);
        var date6 = new Date(2000, 1, 2)
        var date7 = new Date(1378218728000);
        var date8 = new Date(3600 * 24 * 1000);
        var date9 = new Date(-3600 * 24 * 1000);
        var date10 = new Date('January 6, 2013');
        var date11 = new Date('2013-2-15');
        var date12 = new Date('2013/2/15');
        var date13 = new Date('02/15/2013');
        var date14 = new Date('2013-FEB-15');
        var date15 = new Date('FEB, 15, 2013');
        var date16 = new Date('FEB 15, 2013');
        var date17 = new Date('Feberuary, 15, 2013');
        var date18 = new Date('Feberuary 15, 2013');
        var date19 = new Date('15 Feb 2013');
        var date20 = new Date('15, Feberuary, 2013');
        var date21 = new Date('2014-1-1');
        var date22 = new Date(2013, 0);
        var date23 = new Date(2013, 0, 1);
        var date24 = new Date(2013, 0, 1, 0);
        var date25 = new Date(2013, 0, 1, 0, 0, 0, 0);
        var date26 = new Date(2013, 15);
        var date27 = new Date(2013, -1);
        var date28 = new Date(2013, 0, -1);
        var date29 = new Date(0, 0);
        var date30 = new Date(1, 0);
        var date31 = new Date(-1, 0);
